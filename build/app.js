...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (backButton, query, title) {
buf.push("<div class=\"results-page\"><div class=\"container\"><div class=\"row\"><div class=\"col-md-12\"><h1>" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</h1>");
if ( backButton)
{
buf.push("<a class=\"back\"><span class=\"glyphicon glyphicon-chevron-left\"></span>Back</a>");
}
buf.push("<form><div class=\"input-group custom-search-form search\"><input type=\"text\" name=\"q\"" + (jade.attr("value", query, true, false)) + " class=\"form-control\"/><span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\"><span class=\"glyphicon glyphicon-search\"></span></button></span></div></form></div></div><div class=\"row\"><div class=\"col-md-12\"><div class=\"panel panel-primary\"><div class=\"panel-body\">");
if ( backButton)
{
buf.push("<a class=\"show-older\">Show older messages</a>");
}
...
module.exports = Backbone.View.extend({
  ...
  postRender: function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      message = _ref[_i];
      if (message.get('message') !== "" || message.get('attachment') === "1") {
